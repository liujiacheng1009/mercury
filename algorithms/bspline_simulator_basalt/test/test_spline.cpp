...
void testEvaluate(const RdSpline<DIM, N> &spline, int64_t t_ns) {
  using VectorD = typename RdSpline<DIM, N>::VecD;
  using MatrixD = typename RdSpline<DIM, N>::MatD;
...
template <int DIM, int N, int DERIV>
void testTimeDeriv(const RdSpline<DIM, N> &spline, int64_t t_ns) {
  using VectorD = typename RdSpline<DIM, N>::VecD;
...
template <int N>
void testEvaluateSo3(const So3Spline<N> &spline, int64_t t_ns) {
  using VectorD = typename So3Spline<N>::Vec3;
  using MatrixD = typename So3Spline<N>::Mat3;
...
template <int N>
void testVelSo3(const So3Spline<N> &spline, int64_t t_ns) {
  using VectorD = typename So3Spline<N>::Vec3;
  using SO3 = typename So3Spline<N>::SO3;
...
template <int N>
void testAccelSo3(const So3Spline<N> &spline, int64_t t_ns) {
...
template <int N>
void testJerkSo3(const So3Spline<N> &spline, int64_t t_ns) {
  using VectorD = typename So3Spline<5>::Vec3;
...
template <int N>
void testEvaluateSo3Vel(const So3Spline<N> &spline, int64_t t_ns) {
  using VectorD = typename So3Spline<5>::Vec3;
  using MatrixD = typename So3Spline<5>::Mat3;
...
template <int N>
void testEvaluateSo3Accel(const So3Spline<N> &spline, int64_t t_ns) {
  using VectorD = typename So3Spline<N>::Vec3;
  using MatrixD = typename So3Spline<N>::Mat3;
  using SO3 = typename So3Spline<N>::SO3;
